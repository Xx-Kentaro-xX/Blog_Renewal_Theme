...
const privacy_poclicy_popup_display = document.querySelector(".privacy-policy");

// ポップアップ表示する際の背景となる要素を取得
const popup_background_element = document.querySelector(".popup-background");
// ポップアップエリアの要素を取得
const popup_area_element = document.querySelector(".popup-area");
// ポップアップエリアの中の文章エリアを取得
const popup_area_policy_sentence = document.querySelector(".policy-sentences");
